...
- [Day 3]()
    ...
    - [Design Patterns]()
        - [Project Layout](./design/project_layout.md)
        - [Global State](./design/global_state.md)
        - [Panic Handling](./design/panic_handling.md)
        - [Dependency Management in Practice](./design/dependency_management.md)
    - [QA](./day3/wrapup.md)
    - [Thank you!](./day3/thank_you.md)
- [Bonus Content]()
    - [Integration with Other Languages]()
        - [Say Hello to Python](./bonus/python/hello_python.md)
            - [Create a Python Library in Rust](./bonus/python/pyfib.md)
            - [Add a Rust Module](./bonus/python/pyo3_rfib.md)
        - [C Foreign Functions]()
            - [Representations](./bonus/ffi/repr.md)
            - [Linking C into Rust - sys crates](./bonus/ffi/sys_crates.md)
                - [Collaborative: Create a C Library](./bonus/ffi/make_c_library.md)
    - [Lifetimes](./bonus/lifetimes.md)
    - [Ever Wondered what a Proc Macro looks like?](./bonus/proc_macros.md)
    - [FFI Part 1](./bonus/ffi1/intro.md)
        - [Representations](./ffi1/bonus/repr.md)
        - [Linking C into Rust - sys crates](./bonus/ffi1/sys_crates.md)
            - [Collaborative: Create a C Library](./bonus/ffi1/make_c_library.md)
            - [Bindgen for Automatic Headers](./bonus/ffi1/bindgen.md)
            - [C Strings](./bonus/ffi1/c_string.md)
            - [Structures and Pointers](./bonus/ffi1/pointers_structs.md)
            - [Callbacks and Function Pointers](./bonus/ffi1/callbacks.md)
            - [{optional} Task: A C addition library, import into Rust and unit test in Rust](./bonus/ffi1/task1.md)
        - [Linking Rust into C](./bonus/ff1/rust_to_c.md)
        - [C++ Interop](./bonus/ffi2/intro.md)
            - [The CXX Library](./bonus/ffi2/cxx.md)
            - [Walkthrough: instantiate a C++ class and use it](./bonus/ffi2/walk1.md)
            - [Walkthrough: adding Rust to C++](./bonus/ffi2/walk2.md)
            - [Type Conversions](./bonus/ffi2/walk3.md)
